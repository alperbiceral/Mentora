...
const createStyles = (COLORS: ThemeColors, isDark: boolean) =>
  ...
  glow: {
    ...
    height: 260,
    borderRadius: 260,
    backgroundColor: isDark ? "rgba(77,163,255,0.18)" : "rgba(77,163,255,0.12)",
    opacity: 0.25,
  },
  wrapper: {
    flex: 1,
  ...
  timerAura: {
    ...
    height: 240,
    borderRadius: 120,
    backgroundColor: isDark ? "rgba(77,163,255,0.18)" : "rgba(77,163,255,0.10)",
    opacity: 0.7,
  },
  timerRingOuter: {
    width: 210,
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: isDark ? "rgba(15,23,42,0.95)" : COLORS.backgroundAlt,
    shadowColor: "#000",
  ...
  secondaryButton: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: isDark ? "rgba(15,23,42,0.85)" : "rgba(77,163,255,0.10)",
  },
  secondaryButtonText: {
    fontSize: 14,
    fontWeight: "700",
  ...
  segmentedControl: {
    flexDirection: "row",
    backgroundColor: isDark ? "rgba(15,23,42,0.75)" : "rgba(77,163,255,0.10)",
    borderRadius: 999,
    padding: 6,
    borderWidth: 1,
    borderColor: COLORS.borderSubtle,
  ...
  toggleButtonActive: {
    borderColor: COLORS.accent,
    backgroundColor: isDark ? "rgba(77,163,255,0.20)" : "rgba(77,163,255,0.18)",
  },
  toggleText: {
    fontSize: 12,
    fontWeight: "700",
