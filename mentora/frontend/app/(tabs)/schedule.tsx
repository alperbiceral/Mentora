  ...
  return (
    <View style={styles.infoCard}>
      ...
      <Text style={styles.infoText}>
        Upload PDF or a weekly plan image and we will extract blocks automatically.
        For now, use the Add Course button to enter them.
      </Text>
...
const createStyles = (COLORS: ThemeColors, isDark: boolean) =>
  ...
  segmentContainer: {
    flexDirection: "row",
    backgroundColor: isDark ? "rgba(15,23,42,0.8)" : "rgba(2,6,23,0.04)",
    borderRadius: 999,
    padding: 4,
    borderWidth: 1,
  ...
  infoCard: {
    backgroundColor: isDark ? "rgba(2,6,23,0.5)" : COLORS.card,
    borderRadius: 16,
    padding: SPACING.md,
    borderWidth: 1,
    borderColor: COLORS.borderSubtle,
