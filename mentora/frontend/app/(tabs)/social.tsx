...
export default function SocialScreen() {
  ...
  const handleOpenGroupChat = (threadId?: number | null) => {
    ...
    if (!normalizedThreadId) {
      ...
      Alert.alert(
        "Chat unavailable",
        "This group has no valid chat thread yet.",
      );
      return;
    }
    router.push({
                        ...
                        >
                          {({ pressed }) => (
                            <Ionicons
                              ...
                              size={15}
                              color={
                                pressed ? COLORS.accent : COLORS.textSecondary
                              }
                            />
                          )}
                        </Pressable>
                          ...
                          {({ pressed }) =>
                            removingFriendUsername === friend.username ? (
                              <ActivityIndicator
                                size="small"
                                color={
                                  pressed ? COLORS.danger : COLORS.textSecondary
                                }
                              />
                            ) : (
                              <Ionicons
              ...
              {groupMembersViewLoading ? (
                ...
                groupMembersViewList.map((member) => {
                  ...
                  return (
                    <View
                      key={member.username}
                      style={styles.groupMemberListItem}
                    >
